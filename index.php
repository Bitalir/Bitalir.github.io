...
<body>
<img src="/img/graphics/landing/chel.png" width="1" height="1" alt="preload"/>
...
<div class="page-con-content landing-con-override">
				...
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
						     <h1>Что такое чёрная дыра?
						     И что в ней происходит?</h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
								 
								 Вы когда-нибудь задумывались что происходит в чёрных дырах и как оно влияет на нас? 
							</p>
					...
					<div class='landing-img-hero' style="background: url(/img/graphics/landing/chel.png) no-repeat center; background-size: contain;">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="landing-con-discord darkmode-discord">
		...
		<div class="discord-center-logo">
			<img alt="Discord Logo" src="/img/graphics/svg/top1.png" style="width: 100%; height: 100%;">
		</div>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									Всегда хотели узнать, что такое чёрная дыра и как она устроена? Если да, то вам следует задержаться у нас 
								</p>
							</div>
					...
					<div class="github-con-mantra">
						<div class="github-wrp-mantra scale-content-txt-1 ">
							<div class="github-tx1-mantra darkmode-txt">
								<h2>Что такое чёрная дыра?</h2>
								<div class="landing-con-divider">
								</div>
							</div>
							<div class="github-tx2-mantra darkmode-txt">
								<p>
									 Чёрная дыра — область пространства-времени, гравитационное притяжение которой настолько велико, что покинуть её не могут даже объекты, движущиеся со скоростью света, в том числе кванты самого света. Интересно? Читай дальше.
								</p>
							</div>
